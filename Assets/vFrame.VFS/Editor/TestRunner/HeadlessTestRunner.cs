...
namespace vFrame.VFS.Editor.TestRunner
{
    /// <summary>
    ///     In-process EditMode test runner for the vFrame.VFS project. Runs tests via
    ...
    ///
    ///     <para>
    ///         This is a self-contained copy of vFrame.Core.Unity's HeadlessTestRunner:
    ///         the VFS test asmdef must stay minimal, and referencing the shared
    ///         Core.Unity runner would drag extra assemblies into the editortest
    ///         graph. Keep this file in sync with the Core.Unity original.
    ///     </para>
    ///     <para>
    ///         Usage:
    ///         <code>
    /// Unity -batchmode -nographics -quit -projectPath &lt;VFS&gt; `
    ///   -executeMethod vFrame.VFS.Editor.TestRunner.HeadlessTestRunner.RunAllEditMode `
    ///   -logFile &lt;path&gt;
    ///         </code>
    ///     </para>
